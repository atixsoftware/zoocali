...
public class UniWebViewInterface {
    ...
    public static void Load(string name, string url) { CheckPlatform(); }
    public static void LoadHTMLString(string name, string html, string baseUrl) { CheckPlatform(); }
    ...
    public static void SetCookie(string url, string cookie) { CheckPlatform(); }
    public static string GetCookie(string url, string key) { CheckPlatform(); return ""; }
