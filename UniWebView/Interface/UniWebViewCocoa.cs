...
public class UniWebViewInterface {
    ...
    [DllImport(DllLib)]
    private static extern void uv_load(string name, string url);
    ...
    [DllImport(DllLib)]
    private static extern void uv_loadHTMLString(string name, string html, string baseUrl);
    public static void LoadHTMLString(string name, string html, string baseUrl) {
        CheckPlatform();
        uv_loadHTMLString(name, html, baseUrl);
    }
    ...
    [DllImport(DllLib)]
    private static extern void uv_setCookie(string url, string cookie);
    public static void SetCookie(string url, string cookie) {
        CheckPlatform();
        uv_setCookie(url, cookie);
    }

    [DllImport(DllLib)]
    private static extern string uv_getCookie(string url, string key);
    public static string GetCookie(string url, string key) {
        CheckPlatform();
        return uv_getCookie(url, key);
    }
